...
public class MovementConstants
{
	...
	public static final List<TransportLoader.MagicMushtree> MUSHTREES = List.of(
		new TransportLoader.MagicMushtree(new WorldPoint(3676, 3871, 0), WalkerWidgetInfo.FOSSIL_MUSHROOM_MEADOW),
		new TransportLoader.MagicMushtree(new WorldPoint(3764, 3879, 1), WalkerWidgetInfo.FOSSIL_MUSHROOM_HOUSE),
		new TransportLoader.MagicMushtree(new WorldPoint(3676, 3755, 0), WalkerWidgetInfo.FOSSIL_MUSHROOM_SWAMP),
		new TransportLoader.MagicMushtree(new WorldPoint(3760, 3758, 0), WalkerWidgetInfo.FOSSIL_MUSHROOM_VALLEY)
	);
	...
	public static final Map<Integer, Pair<WorldPoint, WorldPoint>> DRAYNOR_MANOR_BASEMENT_DOORS = Map.of(
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_1_STATE, Pair.of(new WorldPoint(3108, 9757, 0), new WorldPoint(3108, 9759, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_2_STATE, Pair.of(new WorldPoint(3104, 9760, 0), new WorldPoint(3106, 9760, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_3_STATE, Pair.of(new WorldPoint(3102, 9757, 0), new WorldPoint(3102, 9759, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_4_STATE, Pair.of(new WorldPoint(3101, 9760, 0), new WorldPoint(3098, 9760, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_5_STATE, Pair.of(new WorldPoint(3097, 9762, 0), new WorldPoint(3097, 9764, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_6_STATE, Pair.of(new WorldPoint(3099, 9765, 0), new WorldPoint(3101, 9765, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_7_STATE, Pair.of(new WorldPoint(3104, 9765, 0), new WorldPoint(3106, 9765, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_8_STATE, Pair.of(new WorldPoint(3102, 9764, 0), new WorldPoint(3102, 9762, 0)),
		WalkerVarbits.DRAYNOR_MANOR_BASEMENT_DOOR_9_STATE, Pair.of(new WorldPoint(3101, 9755, 0), new WorldPoint(3099, 9755, 0))
	);
}
